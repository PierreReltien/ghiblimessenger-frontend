...
function Hashtag() {
  ...
  useEffect(() => {
    ...
    fetch(`https://ghiblimessenger-backend.vercel.app/tweets/hashtag/${user.token}/${hashtag}`)
  ...
  return (
    <div className={styles.container}>
      <div className={styles.leftSection}>
        <div>
          <Link href="/">
            <Image src="/totorologo2.png" alt="Logo" width={50} height={50} className={styles.logo} />
          </Link>
        </div>
        <div>
