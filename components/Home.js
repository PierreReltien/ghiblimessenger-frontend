...
function Home() {
  ...
  useEffect(() => {
    ...
    fetch(`https://ghiblimessenger-backend.vercel.app/tweets/all/${user.token}`)
  ...
  const handleSubmit = () => {
    fetch('https://ghiblimessenger-backend.vercel.app/tweets', {
      method: 'POST',
  ...
  return (
    <div className={styles.container}>
      <div className={styles.leftSection}>
        <div>
          <Link href="/">
            <Image src="/totorologo2.png" alt="Logo" width={100} height={100} className={styles.logo} />
          </Link>
        </div>
        <div>
      ...
      <div className={styles.middleSection}>
        ...
        <div className={styles.createSection}>
          ...
          <div className={styles.validateTweet}>
            ...
            <button className={styles.button} onClick={() => handleSubmit()}>Ghible</button>
          </div>
        </div>
        <LastTweets />
      </div>
